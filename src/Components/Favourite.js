...
export default class Favourite extends Component {
  ...
  // Movies state is made because, when we delete a movie from the favourite, then our page should be re rendered.
  // And, hence we want to have some state for it which will be movies.
  constructor(){
    super();
    this.state={
      genres:[],
            ...
            <div className="row">
                  ...
                  <div className="col-lg-9 favourites-table col-sm-12">
                      <div className='row'>
                        ...
                        <input type="number" placeholder='Rows Count' className="input-group-text col" value={this.state.limit} onChange={(e)=>this.setState({limit:e.target.value})}/>
                      </div>
                  ...
                  <div className="row">
                      <table class="table">
                        ...
                        <th scope="col"><i class="fas fa-sort-up" onClick={this.sortRatingDesc} />Rating<i class="fas fa-sort-down" onClick={this.sortRatingAsc} /></th>
                            {/* Below Empty column was specified because we wanted delete column separate. */}
                            <th scope="col"></th>
                        ...
                        <tbody>
                          {
                            filterarr.map((movieObj) => (
                              <tr>
                                <td><img src={`https://image.tmdb.org/t/p/original${movieObj.backdrop_path}`} style={{width:'6rem', paddingRight:'0.6rem'}} alt={movieObj.title}/>{movieObj.original_title}</td>
